...
\hline {1} &  1 & {0} & {6.14933} & {1.95138} & {0} & {0} & {0}\\
\hline {2} &  0.99555 & {-11.7319} & {6} & {3.6} & {0} & {0} & {1}\\ 
\hline {3} &  1 & {-27.1476} & {3.1} & {2.5691} & {0} & {0} & {2}\\
\hline {4} &  1.01568 & {-22.5969} & {1.6} & {0.7} & {0} & {0} & {2}\\ 
\hline {5} &  1.04217 & {-30.9118} & {4.3} & {3.34} & {0} & {0} & {2}\\
\hline {6} &  1 & {-40.1537} & {-0.01} & {0.70155} & {0} & {0} & {2}\\ 
\hline {7} &  1 & {-11.4909} & {2.25} & {0.32119} & {0} & {0} & {2}\\ 
\hline {8} &  1 & {-11.3848} & {3.06} & {0.4354} & {0} & {0} & {2}\\ 
